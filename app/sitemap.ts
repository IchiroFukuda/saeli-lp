...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  if (host.includes("mainichi-anoko.com")) {
    ...
    const items: MetadataRoute.Sitemap = [
      ...
      { url: `${base}/blog/tachinaori`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
      { url: `${base}/blog/symptom`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
      { url: `${base}/blog/dog`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
      { url: `${base}/blog/cat`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
